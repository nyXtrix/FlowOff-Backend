...
public record RegisterCompanyRequest(string RegistrationToken, string CompanyName, string Subdomain, string FirstName, string LastName, string AdminEmail, string AdminPassword);
